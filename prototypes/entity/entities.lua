--data.raw["Type"]["Name"]["Property"] = new_value
data:extend(
{
  {
    type = "storage-tank",
    name = "storage-tank-test",
    icon = "__MajiirStar__/graphics/icons/storage-tank-test.png",
    ...
    pictures =
    {
      picture =
      {
        sheet =
        {
          filename = "__MajiirStar__/graphics/entity/storage-tank/storage-tank.png",
          priority = "extra-high",
          frames = 1,
          width = 24,
          height = 46,
